...
class AnalysisResult(models.Model):
    """
    Class which represents the result of an detection analysis on a user’s submission.
    ...
    confidence_score = models.FloatField(
        ...
        help_text="Confidence score between 0.0 and 1.0 (higher = more confident)."
    )
    ...
    reason = models.TextField(
        null=True,
        blank=True,
        help_text="Explanation of why the content was classified as AI-generated or human-written."
    )   
